...
export interface IReminderRepository {
	create(channelId: DiscordChannelId, userId: DiscordUserId, receiveUserName: ReceiveDiscordUserName, message: ReminderMessage, remindAt: RemindTime): Promise<boolean>;
